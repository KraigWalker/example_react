			...
			<div className="connect">
				<div className="container">
					<div className="loading-spinner">
						<svg width='58px' height='58px' viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="uil-ring">
